...
<body>
    ...
    <main>
        ...
        <div class="container">
            <?php echo $logado; ?>
            <form class="form_container" action="./php_cadastro/cadastro_cliente.php" method="post">
                <div class="input_nome">
                    <div class="nome">
                        <label class="input_label" for="email_field">Nome:</label>
                        <input placeholder="Nome" title="Primeiro nome" name="nome" type="text" class="input_name" value="<?php echo $logado; ?>" required>
                    </div>
                    <div class="nome">
                        <label class="input_label" for="email_field">Sobrenome:</label>
                        <input placeholder="Sobrenome" title="Sobrenome completo" name="sobrenome" type="text" class="input_sname" required>
                    </div>
                </div>
                <div class="input_nome">
                    <div class="nome">
                        <label class="input_label" for="email_field">CPF:</label>
                        <input oninput="mascara(this)" placeholder="123.456.789-10" name="cpf" type="text" class="input_name" required>
                    </div>
                    <div class="nome">
                        <label class="input_label" for="email_field">Nascimento:</label>
                        <input placeholder="Sobrenome" title="Sobrenome completo" name="dt_nascimento" type="date" class="input_sname" required />
                    </div>
                </div>
                ...
                <div class="input_container">
                    <div class="input_nome">
                        <div class="nome">
                            ...
                            <input class="input_name" type="tel" placeholder="Informe o Cep" id="cep" name="cep" maxlength="8" />
                    ...
                    <input class="input_field" type="text" class="big-field" placeholder="Rua da Consolação" name="endereco" id="endereco" />

                    <label class="input_label" for="nr_end">Número</label>
                    <input class="input_field" type="text" class="big-field" name="numero" placeholder="Número da casa" name="nr_end" id="nr_end" />
                </div>
                <div class="input_contato">
                    <label class="input_label" for="password_field">Contato:</label>
                    <input onkeyup="handlePhone(event)" maxlength="15" placeholder="(ddd) 00000-0000" title="Número para Contato" name="telefone" type="text" class="input_field" />
                    <input placeholder="E-mail" title="E-Mail" name="email" type="email" class="input_field" id="email_field" required />
                </div>
                <div class="input_container">
                    <div>
                        <label class="input_label" for="password_field">Senha:</label>
                        <input placeholder="Senha" id="senha" title="Senha" name="senha" type="password" class="input_field" required />
                ...
                <div class="input_container">
                    <div>
                        ...
                        <input placeholder="Senha" id="senhaa" title="Insira sua senha novamente" name="confirmacao_senha" type="password" class="input_field" required />
