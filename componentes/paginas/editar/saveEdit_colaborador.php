...
move_uploaded_file($fotoTemp, $fotoCaminho);
        ...
        SET nome='$nome', cad_foto='$fotoNome', sobrenome='$sobrenome', cpf='$cpf', dt_nascimento='$dt_nascimento', genero='$genero', profissao='$profissao', cep='$cep', uf='$uf', cidade='$cidade', bairro='$bairro', endereco='$endereco', numero='$numero', telefone='$telefone', descricao='$descricao', email='$email', senha='$senha' WHERE id_colaborador='$id_colaborador'";
