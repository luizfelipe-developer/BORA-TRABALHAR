...
if (isset($_POST['bt-entrar'])) {
    ...
    if ($row_cliente) {
        ...
        header("Location: ../../cliente/confirma_usuario.html");// Redirecionar para a página do cliente
    } elseif ($row_colaborador) {
        $_SESSION['online'] = true;
        $_SESSION['cpf'] = $cpf;
        $_SESSION['tipo'] = 'colaborador';
        header("Location: ../../trabalhador/trabalhadorr.php");// Redirecionar para a página do colaborador
    } else {
